...
<body>
  ...
  <div class="container-fluid d-flex p-0 m-0">
    ...
    <div class="col-9" id="viewHolder" style="background-image: url('/img/guest.jpg'); background-size: cover; background-repeat: no-repeat;">
      <div class="container">
            ...
            <div class="card-body">
              <form method="post" action="staffdash">@csrf
                <div class="input-group form-group">
                  ...
                  <input type="number" class="form-control" placeholder="GuestID" name="userid" required>
