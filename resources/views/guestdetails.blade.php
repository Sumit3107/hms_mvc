                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="schedule-warp">
                      <div class="day-one">Personal details<a href="javascript:history.go(0)" id="an" class="ml-5 previous">&laquo; Dashboard</a></div>
                        <div class="row">
                            <h5 class="col-4">First Name</h5>
                            <p class="col-2">Vivek </p>
                            <h5 class="col-4">Last Name</h5>
                            <p class="col-2">Tiwari</p>
                            <hr class="col-10">
                            <h5 class="col-4">Adhaar No.</h5>
                            <p class="col-8">852140256521</p>
                            <hr class="col-10">
                            <h5 class="col-4">Room No.</h5>
                            <p class="col-2">214</p>
                            <hr class="col-10">
                            <h5 class="col-4">D.O.B</h5>
                            <p class="col-2">31/07/1999</p>
                            <hr class="col-10">
                            <h5 class="col-5">Room category</h5>
                            <p class="col-3">Single bed</p>
