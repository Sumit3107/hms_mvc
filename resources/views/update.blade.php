                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="schedule-warp">
                      <div class="day-one">Update details<a href="javascript:history.go(0)" id="an" class="ml-5 previous">&laquo; Dashboard</a></div>
                        <form action="" method="get">
                                
                                <div class="text-center">
                                    <button type="button" class="btn-sm btn-success mt-3" onclick="myfunc()">Submit</button>
                                </div>
                        </form>
                        <!-- end date -->
                      </div>
